...
#define WHSECALLBACKAPI __fastcall *
...
typedef WHSE_CALLBACK_RETURNTYPE ( WHSECALLBACKAPI WHSE_EXIT_MEMORYACCESS_CALLBACK )( WHSE_PARTITION* Partition, WHSE_VP_EXIT_CONTEXT* VpContext, WHSE_MEMORY_ACCESS_CONTEXT* ExitContext );

typedef WHV_X64_IO_PORT_ACCESS_CONTEXT WHSE_IO_PORT_ACCESS_CONTEXT;
typedef WHSE_CALLBACK_RETURNTYPE ( WHSECALLBACKAPI WHSE_EXIT_IO_PORT_ACCESS_CALLBACK )( WHSE_PARTITION* Partition, WHSE_VP_EXIT_CONTEXT* VpContext, WHSE_IO_PORT_ACCESS_CONTEXT* Context );

typedef void WHSE_UNRECOVERABLE_EXCEPTION_CONTEXT;
typedef WHSE_CALLBACK_RETURNTYPE ( WHSECALLBACKAPI WHSE_EXIT_UNRECOVERABLE_EXCEPTION_CALLBACK )( WHSE_PARTITION* Partition, WHSE_VP_EXIT_CONTEXT* VpContext, WHSE_UNRECOVERABLE_EXCEPTION_CONTEXT* Context );

typedef void WHSE_INVALID_REGISTER_VALUE_CONTEXT;
typedef WHSE_CALLBACK_RETURNTYPE ( WHSECALLBACKAPI WHSE_EXIT_INVALID_REGISTER_VALUE_CALLBACK )( WHSE_PARTITION* Partition, WHSE_VP_EXIT_CONTEXT* VpContext, WHSE_INVALID_REGISTER_VALUE_CONTEXT* Context );

typedef WHV_X64_UNSUPPORTED_FEATURE_CONTEXT WHSE_UNSUPPORTED_FEATURE_CONTEXT;
typedef WHSE_CALLBACK_RETURNTYPE ( WHSECALLBACKAPI WHSE_EXIT_UNSUPPORTED_FEATURE_CALLBACK )( WHSE_PARTITION* Partition, WHSE_VP_EXIT_CONTEXT* VpContext, WHSE_UNSUPPORTED_FEATURE_CONTEXT* Context );

typedef WHV_X64_INTERRUPTION_DELIVERABLE_CONTEXT WHSE_INTERRUPTION_DELIVERY_CONTEXT;
typedef WHSE_CALLBACK_RETURNTYPE ( WHSECALLBACKAPI WHSE_EXIT_INTERRUPTION_DELIVERY_CALLBACK )( WHSE_PARTITION* Partition, WHSE_VP_EXIT_CONTEXT* VpContext, WHSE_INTERRUPTION_DELIVERY_CONTEXT* Context );

typedef void WHSE_HALT_CONTEXT;
typedef WHSE_CALLBACK_RETURNTYPE ( WHSECALLBACKAPI WHSE_EXIT_HALT_CALLBACK )( WHSE_PARTITION* Partition, WHSE_VP_EXIT_CONTEXT* VpContext, WHSE_HALT_CONTEXT* Context );

typedef WHV_X64_APIC_EOI_CONTEXT WHSE_APIC_EOI_CONTEXT;
typedef WHSE_CALLBACK_RETURNTYPE ( WHSECALLBACKAPI WHSE_EXIT_APIC_EOI_CALLBACK )( WHSE_PARTITION* Partition, WHSE_VP_EXIT_CONTEXT* VpContext, WHSE_APIC_EOI_CONTEXT* Context );

typedef WHV_X64_MSR_ACCESS_CONTEXT WHSE_MSR_ACCESS_CONTEXT;
typedef WHSE_CALLBACK_RETURNTYPE ( WHSECALLBACKAPI WHSE_EXIT_MSR_ACCESS_CALLBACK )( WHSE_PARTITION* Partition, WHSE_VP_EXIT_CONTEXT* VpContext, WHSE_MSR_ACCESS_CONTEXT* Context );

typedef WHV_X64_CPUID_ACCESS_CONTEXT WHSE_CPUID_ACCESS_CONTEXT;
typedef WHSE_CALLBACK_RETURNTYPE ( WHSECALLBACKAPI WHSE_EXIT_CPUID_ACCESS_CALLBACK )( WHSE_PARTITION* Partition, WHSE_VP_EXIT_CONTEXT* VpContext, WHSE_CPUID_ACCESS_CONTEXT* Context );

typedef WHV_VP_EXCEPTION_CONTEXT WHSE_VP_EXCEPTION_CONTEXT;
typedef WHSE_CALLBACK_RETURNTYPE ( WHSECALLBACKAPI WHSE_EXIT_VP_EXCEPTION_CALLBACK )( WHSE_PARTITION* Partition, WHSE_VP_EXIT_CONTEXT* VpContext, WHSE_VP_EXCEPTION_CONTEXT* Context );

typedef void WHSE_RDTSC_ACCESS_CONTEXT;
typedef WHSE_CALLBACK_RETURNTYPE ( WHSECALLBACKAPI WHSE_EXIT_RDTSC_ACCESS_CALLBACK )( WHSE_PARTITION* Partition, WHSE_VP_EXIT_CONTEXT* VpContext, WHSE_RDTSC_ACCESS_CONTEXT* Context );

typedef WHV_RUN_VP_CANCELED_CONTEXT WHSE_USER_CANCELED_CONTEXT;
typedef WHSE_CALLBACK_RETURNTYPE ( WHSECALLBACKAPI WHSE_EXIT_USER_CANCELED_CALLBACK )( WHSE_PARTITION* Partition, WHSE_VP_EXIT_CONTEXT* VpContext, WHSE_USER_CANCELED_CONTEXT* Context );

typedef struct WHSE_EXIT_CALLBACKS {
...
static_assert( ( sizeof( WHSE_EXIT_CALLBACKS ) / sizeof( uintptr_t ) ) == WHSE_EXIT_CALLBACK_SLOT::NumberOfCallbacks, "( sizeof( WHSE_EXIT_CALLBACKS ) / sizeof( uintptr_t ) ) != WHSE_EXIT_CALLBACK_SLOT::NumberOfCallbacks" );
...
typedef struct WHSE_PARTITION {
	...
	WHSE_VMEXIT_CALLBACKS ExitCallbacks;
};
